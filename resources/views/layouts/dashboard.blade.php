    ...
    <nav>
        ...
        <ul>
            ...
            <li {!! Request::is('dashboard') ? ' class="active"' : '' !!}>
                <a href="{{ URL::route('dashboard.card') }}"><i class="fa fa-fw fa-home"></i> Главная</a>
            </li>
            ...
            <li class="">
                ...
                <ul class="treeview-menu">
                    <li {!! Request::is('dashboard/user*') ? ' class="active"' : '' !!}><a href="{{ URL::route('dashboard.user.list') }}"><i class="fa fa-list"></i> Список пользователей</a></li>
                    <li {!! Request::is('dashboard/role*') ? ' class="active"' : '' !!}><a href="{{ URL::route('dashboard.role.list') }}"><i class="fa fa-list"></i> Список ролей</a>
                    </li>
                </ul>
            </li>
            @endif
...
@include('layouts.dashboard_common.script')
