        ...
        <div class="col">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    {!! Form::open(['url' => isset($userData) ? URL::route('dashboard.user.update') : URL::route('dashboard.user.store'), 'files' => true, 'method' => isset($userData) ? 'put' : 'post', 'class' => 'form-horizontal', 'id' => "dashboard"]) !!}
                    ...
                    <div class="box-footer">
                        <div class="col-sm-4">
                            <a href="{{ URL::route('dashboard.user.list') }}" class="btn btn-danger btn-flat pull-right">Отменить</a>
                        </div>
                        <div class="col-sm-5">
