                        ...
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-12 padding-bottom-10">
                                    <a href="{{ URL::route('dashboard.role.create') }}"  class="btn btn-info btn-sm pull-left"><span class="fa fa-plus"> &nbsp;</span>Добавить роль</a>
                                </div>
                            </div>
                        </div>
                    @endif
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = $("#itemList").DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: '{!! URL::route('dashboard.datatable.role') !!}',
                columns: [
                    {data: 'name', name: 'name'},
            ...
            $('#itemList').on('click', 'a.deleteRow', function () {
                ...
                swal({
                    ...
                    function(isConfirm){
                        if (!isConfirm) return;
                        $.ajax({
                            url: SITE_URL + "/dashboard/role/delete/" + rowid,
                            type: "DELETE",
                            dataType: "html",
