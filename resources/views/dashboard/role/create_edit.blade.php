        ...
        <div class="col">
            ...
            <div class="jarviswidget jarviswidget-color-blueDark" data-widget-editbutton="false">
                ...
                <div>
                    ...
                    {!! Form::open(['url' => isset($role) ? URL::route('dashboard.role.update') : URL::route('dashboard.role.store'), 'method' => isset($role) ? 'put' : 'post', 'class' => 'form-horizontal', 'id' => "addRole"]) !!}
                    ...
                    <div class="box-footer">
                        <div class="col-sm-4">
                            <a href="{{ URL::route('dashboard.role.list') }}" class="btn btn-danger btn-flat pull-right">Отменить</a>
                        </div>
