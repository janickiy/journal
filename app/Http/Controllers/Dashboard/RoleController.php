...
class RoleController extends Controller
{
    ...
    {
        return view('dashboard.role.list')->with('title', 'Роли');
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.role.create_edit', compact('permissions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('dashboard/role/list')->with('success', 'Информация успешно добавлена');
        }
    }
 ...
 */
    public function edit($id)
    {
        ...
        return view('dashboard.role.create_edit', compact('role','permissions', 'stored_permissions'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('dashboard/role/list')->with('success', 'Данные обновлены');
        }
    }
